...
if (URLhash == '#comision') {
    ...
    document.querySelector('#comision').classList.remove('inactivo');
    verificarActivos(document.querySelector('#transmedia'));
    verificarActivos(document.querySelector('#escuela'));
    verificarActivos(document.querySelector('#qlvsdicha'));
    verificarActivos(document.querySelector('#botiquin'));
    if (linkatras.classList.contains('sinopaco') == false) {
        linkatras.classList.add('sinopaco');
    }
} else if (URLhash == '#transmedia') {
    document.querySelector('.opcion1').classList.add('inactivo');
    document.querySelector('#transmedia').classList.remove('inactivo');
    verificarActivos(document.querySelector('#comision'));
    verificarActivos(document.querySelector('#escuela'));
    verificarActivos(document.querySelector('#qlvsdicha'));
    verificarActivos(document.querySelector('#botiquin'));
    if (linkatras.classList.contains('sinopaco') == false) {
...
} else if (URLhash == '#escuela') {
    document.querySelector('.opcion1').classList.add('inactivo');
    document.querySelector('#escuela').classList.remove('inactivo');
    verificarActivos(document.querySelector('#comision'));
    verificarActivos(document.querySelector('#transmedia'));
    verificarActivos(document.querySelector('#qlvsdicha'));
    verificarActivos(document.querySelector('#botiquin'));
...
} else if (URLhash == '#qlvsdicha') {
    document.querySelector('.opcion1').classList.add('inactivo');
    document.querySelector('#qlvsdicha').classList.remove('inactivo');
    verificarActivos(document.querySelector('#comision'));
    verificarActivos(document.querySelector('#transmedia'));
    verificarActivos(document.querySelector('#escuela'));
    verificarActivos(document.querySelector('#botiquin'));
...
} else if (URLhash == '#botiquin') {
    document.querySelector('.opcion1').classList.add('inactivo');
    document.querySelector('#botiquin').classList.remove('inactivo');
    verificarActivos(document.querySelector('#comision'));
    verificarActivos(document.querySelector('#transmedia'));
    verificarActivos(document.querySelector('#escuela'));
    verificarActivos(document.querySelector('#qlvsdicha'));
